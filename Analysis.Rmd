...
name_undirected_man <- readRDS("~/Documents/Projects/SAVA_multilayer/everyone_name_undirected_Mandena12.RDS")
name_undirected_sara <- readRDS("~/Documents/Projects/SAVA_multilayer/everyone_name_undirected_Sarahandrano123.RDS")
name_undirected_anda <- readRDS("~/Documents/Projects/SAVA_multilayer/everyone_name_undirected_andatsakala123.RDS")
...
enviro_mand_edge <- enviro_adj2 %>% filter(village =="Mandena") %>% select(id1, id2, weight)
enviro_sara_edge <- enviro_adj2 %>% filter(village =="Sarahandrano") %>% select(id1, id2, weight)
enviro_anda_edge <- enviro_adj2 %>% filter(village =="Andatsakala") %>% select(id1, id2, weight) 
...
contact_mand_edge <- contact_adj %>% filter(village =="Mandena") %>% select(id1, id2, close_contact_edge) %>% rename("weight" = "close_contact_edge") %>% filter(weight!=0)
contact_sara_edge <- contact_adj %>% filter(village =="Sarahandrano") %>% select(id1, id2, close_contact_edge) %>% rename("weight" = "close_contact_edge") %>% filter(weight!=0)
contact_anda_edge <- contact_adj %>% filter(village =="Andatsakala") %>% select(id1, id2, close_contact_edge) %>% rename("weight" = "close_contact_edge") %>% filter(weight!=0)

#Naming network

name_undirected_man2 <-name_undirected_man$n.named
name_undirected_sara2 <-name_undirected_sara$n.named
name_undirected_anda2 <-name_undirected_anda$n.named

name_mand_edge <- igraph::as_data_frame(name_undirected_man2) %>% rename(id1 = from, id2 = to)
name_sara_edge <- igraph::as_data_frame(name_undirected_sara2)%>% rename(id1 = from, id2 = to)
name_anda_edge <- igraph::as_data_frame(name_undirected_anda2)%>% rename(id1 = from, id2 = to)
...
distance_mand_edge <- distance_edges %>% filter(village=="Mandena")
distance_anda_edge <- distance_edges %>% filter(village=="Andatsakala")
distance_sara_edge <- distance_edges %>% filter(village=="Sarahandrano")


```

```{r Build Networks: Mandena}
#Setup intra-layer edge lists
enviro_mand_edge <- enviro_mand_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =1, layer.to =1) %>% select(node.from, layer.from, node.to, layer.to, weight) %>% mutate(weight = rescale(weight,to = c(0.01,1)))

contact_mand_edge <- contact_mand_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =2, layer.to =2)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))

name_mand_edge <- name_mand_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =3, layer.to =3)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))


ggplot(data= enviro_mand_edge, aes(x = weight))+ geom_histogram()
ggplot(data= contact_mand_edge, aes(x = weight))+ geom_histogram()
ggplot(data= name_mand_edge, aes(x = weight))+ geom_histogram()

mean(enviro_mand_edge$weight)
mean(contact_mand_edge$weight)
mean(name_mand_edge$weight)
mean(c(enviro_mand_edge$weight, contact_mand_edge$weight, name_mand_edge$weight))

name_mand_edge <- name_mand_edge %>% filter(node.to %in% node.from)#filter out people named in different villages 

```

```{r Build Networks: Sarahandrano}
#Setup intra-layer edge lists
enviro_sara_edge <- enviro_sara_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =1, layer.to =1) %>% select(node.from, layer.from, node.to, layer.to, weight) %>% mutate(weight = rescale(weight,to = c(0.01,1)))
contact_sara_edge <- contact_sara_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =2, layer.to =2)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))
name_sara_edge <- name_sara_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =3, layer.to =3)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))

name_sara_edge <- name_sara_edge %>% filter(node.to %in% node.from)#filter out people named in different villages 



```

```{r Build Networks: Andatsakala}
#Setup intra-layer edge lists
enviro_anda_edge <- enviro_anda_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =1, layer.to =1) %>% select(node.from, layer.from, node.to, layer.to, weight) %>% mutate(weight = rescale(weight,to = c(0.01,1)))
contact_anda_edge <- contact_anda_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =2, layer.to =2)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))
name_anda_edge <- name_anda_edge %>% rename(node.from =id1, node.to = id2)%>% mutate(layer.from =3, layer.to =3)%>% select(node.from, layer.from, node.to, layer.to, weight)%>% mutate(weight = rescale(weight,to = c(0.01,1)))

name_anda_edge <- name_anda_edge %>% filter(node.to %in% node.from)#filter out people named in different villages 
...
#Mandena
enviro_mand_g <- graph_from_edgelist(as.matrix(enviro_mand_edge[,c(1,3)]), directed = FALSE)
name_mand_g <- graph_from_edgelist(as.matrix(name_mand_edge[,c(1,3)]), directed = FALSE)
contact_mand_g <- graph_from_edgelist(as.matrix(contact_mand_edge[,c(1,3)]), directed = FALSE)
distance_mand_g <- graph_from_edgelist(as.matrix(distance_mand_edge[,c(1,2)]), directed = FALSE)

enviro_mand_g<-simplify(enviro_mand_g, remove.multiple = FALSE, remove.loops = TRUE)
name_mand_g<-simplify(name_mand_g, remove.multiple = FALSE, remove.loops = TRUE)
contact_mand_g<-simplify(contact_mand_g, remove.multiple = FALSE, remove.loops = TRUE)
distance_mand_g<-simplify(distance_mand_g, remove.multiple = FALSE, remove.loops = TRUE)

E(enviro_mand_g)$weight <- enviro_mand_edge$weight
E(name_mand_g)$weight <- name_mand_edge$weight
E(contact_mand_g)$weight <- contact_mand_edge$weight
E(distance_mand_g)$weight <- distance_mand_edge$dist

#Sarahandrano
enviro_sara_g <- graph_from_edgelist(as.matrix(enviro_sara_edge[,c(1,3)]), directed = FALSE)
name_sara_g <-graph_from_edgelist(as.matrix(name_sara_edge[,c(1,3)]), directed = FALSE)
contact_sara_g <- graph_from_edgelist(as.matrix(contact_sara_edge[,c(1,3)]), directed = FALSE)
distance_sara_g <- graph_from_edgelist(as.matrix(distance_sara_edge[,c(1,2)]), directed = FALSE)

enviro_sara_g<-simplify(enviro_sara_g, remove.multiple = FALSE, remove.loops = TRUE)
name_sara_g<-simplify(name_sara_g, remove.multiple = FALSE, remove.loops = TRUE)
contact_sara_g<-simplify(contact_sara_g, remove.multiple = FALSE, remove.loops = TRUE)
distance_sara_g<-simplify(distance_sara_g, remove.multiple = FALSE, remove.loops = TRUE)

E(enviro_sara_g)$weight <- enviro_sara_edge$weight
E(name_sara_g)$weight <- name_sara_edge$weight
E(contact_sara_g)$weight <- contact_sara_edge$weight
E(distance_sara_g)$weight <- distance_sara_edge$dist

#Andatsakala
enviro_anda_g <- graph_from_edgelist(as.matrix(enviro_anda_edge[,c(1,3)]), directed = FALSE)
name_anda_g <- graph_from_edgelist(as.matrix(name_anda_edge[,c(1,3)]), directed = FALSE)
contact_anda_g <- graph_from_edgelist(as.matrix(contact_anda_edge[,c(1,3)]), directed = FALSE)
distance_anda_g <- graph_from_edgelist(as.matrix(distance_anda_edge[,c(1,2)]), directed = FALSE)

E(enviro_anda_g)$weight <- enviro_anda_edge$weight
E(name_anda_g)$weight <- name_anda_edge$weight
E(contact_anda_g)$weight <- contact_anda_edge$weight
E(distance_anda_g)$weight <- distance_anda_edge$dist

enviro_anda_g<-simplify(enviro_anda_g, remove.multiple = FALSE, remove.loops = TRUE)
name_anda_g<-simplify(name_anda_g, remove.multiple = FALSE, remove.loops = TRUE)
contact_anda_g<-simplify(contact_anda_g, remove.multiple = FALSE, remove.loops = TRUE)
distance_anda_g<-simplify(distance_anda_g, remove.multiple = FALSE, remove.loops = TRUE)



#CALCULATE CENTRALITY
#Environmental networks
centrality_enviro_mand <- as.data.frame(page_rank(enviro_mand_g)$vector) 
centrality_enviro_mand$Node <- rownames(centrality_enviro_mand)
colnames(centrality_enviro_mand)[1] <- "PageRank"

centrality_enviro_sara <- as.data.frame(page_rank(enviro_sara_g)$vector) 
centrality_enviro_sara$Node <- rownames(centrality_enviro_sara)
colnames(centrality_enviro_sara)[1] <- "PageRank"

centrality_enviro_anda <- as.data.frame(page_rank(enviro_anda_g)$vector) 
centrality_enviro_anda$Node <- rownames(centrality_enviro_anda)
colnames(centrality_enviro_anda)[1] <- "PageRank"

#Close contact networks
centrality_contact_mand <- as.data.frame(page_rank(contact_mand_g)$vector) 
centrality_contact_mand$Node <- rownames(centrality_contact_mand)
colnames(centrality_contact_mand)[1] <- "PageRank"

centrality_contact_sara <- as.data.frame(page_rank(contact_sara_g)$vector) 
centrality_contact_sara$Node <- rownames(centrality_contact_sara)
colnames(centrality_contact_sara)[1] <- "PageRank"

centrality_contact_anda <- as.data.frame(page_rank(contact_anda_g)$vector) 
centrality_contact_anda$Node <- rownames(centrality_contact_anda)
colnames(centrality_contact_anda)[1] <- "PageRank"

#Naming networks
centrality_name_mand <- as.data.frame(page_rank(name_mand_g)$vector) 
centrality_name_mand$Node <- rownames(centrality_name_mand)
colnames(centrality_name_mand)[1] <- "PageRank"

centrality_name_sara <- as.data.frame(page_rank(name_sara_g)$vector) 
centrality_name_sara$Node <- rownames(centrality_name_sara)
colnames(centrality_name_sara)[1] <- "PageRank"

centrality_name_anda <- as.data.frame(page_rank(name_anda_g)$vector) 
centrality_name_anda$Node <- rownames(centrality_name_anda)
colnames(centrality_name_anda)[1] <- "PageRank"

#Distance networks
centrality_distance_mand <- as.data.frame(page_rank(distance_mand_g)$vector) 
centrality_distance_mand$Node <- rownames(centrality_distance_mand)
colnames(centrality_distance_mand)[1] <- "PageRank"

centrality_distance_sara <- as.data.frame(page_rank(distance_sara_g)$vector) 
centrality_distance_sara$Node <- rownames(centrality_distance_sara)
colnames(centrality_distance_sara)[1] <- "PageRank"

centrality_distance_anda <- as.data.frame(page_rank(distance_anda_g)$vector) 
centrality_distance_anda$Node <- rownames(centrality_distance_anda)
colnames(centrality_distance_anda)[1] <- "PageRank"


centrality_name_mand$Strength <- igraph::strength(name_mand_g)
centrality_name_mand$Betweenness <- igraph::betweenness(name_mand_g, weights = 1/E(name_mand_g)$weight, normalized = T)
centrality_name_mand$Eigen <- log(igraph::eigen_centrality(name_mand_g)$vector)

centrality_name_sara$Strength <- igraph::strength(name_sara_g)
centrality_name_sara$Betweenness <- igraph::betweenness(name_sara_g, weights =1/ E(name_sara_g)$weight, normalized = T)
centrality_name_sara$Eigen <- log(igraph::eigen_centrality(name_sara_g)$vector)

centrality_name_anda$Strength <- igraph::strength(name_anda_g)
centrality_name_anda$Betweenness <- igraph::betweenness(name_anda_g, weights = 1/E(name_anda_g)$weight, normalized = T)
centrality_name_anda$Eigen <- log(igraph::eigen_centrality(name_anda_g)$vector)


centrality_contact_mand$Strength <- igraph::strength(contact_mand_g)
centrality_contact_mand$Betweenness <- igraph::betweenness(contact_mand_g, weights = 1/E(contact_mand_g)$weight, normalized = T)
centrality_contact_mand$Eigen <- igraph::eigen_centrality(contact_mand_g)$vector

centrality_contact_sara$Strength <- igraph::strength(contact_sara_g)
centrality_contact_sara$Betweenness <- igraph::betweenness(contact_sara_g, weights = 1/E(contact_sara_g)$weight, normalized = T)
centrality_contact_sara$Eigen <- igraph::eigen_centrality(contact_sara_g)$vector

centrality_contact_anda$Strength <- igraph::strength(contact_anda_g)
centrality_contact_anda$Betweenness <- igraph::betweenness(contact_anda_g, weights = 1/E(contact_anda_g)$weight, normalized = T)
centrality_contact_anda$Eigen <- igraph::eigen_centrality(contact_anda_g)$vector


centrality_enviro_mand$Strength <- igraph::strength(enviro_mand_g)
centrality_enviro_mand$Betweenness <- igraph::betweenness(enviro_mand_g, weights = 1/E(enviro_mand_g)$weight, normalized = T)
centrality_enviro_mand$Eigen <- igraph::eigen_centrality(enviro_mand_g)$vector

centrality_enviro_sara$Strength <- igraph::strength(enviro_sara_g)
centrality_enviro_sara$Betweenness <- igraph::betweenness(enviro_sara_g, weights = 1/E(enviro_sara_g)$weight, normalized = T)
centrality_enviro_sara$Eigen <- igraph::eigen_centrality(enviro_sara_g)$vector

centrality_enviro_anda$Strength <- igraph::strength(enviro_anda_g)
centrality_enviro_anda$Betweenness <- igraph::betweenness(enviro_anda_g, weights = 1/E(enviro_anda_g)$weight, normalized = T)
centrality_enviro_anda$Eigen <- igraph::eigen_centrality(enviro_anda_g)$vector


centrality_distance_mand$Strength <- igraph::strength(distance_mand_g)
centrality_distance_mand$Betweenness <- igraph::betweenness(distance_mand_g, weights = 1/E(distance_mand_g)$weight, normalized = T)
centrality_distance_mand$Eigen <- igraph::eigen_centrality(distance_mand_g)$vector

centrality_distance_sara$Strength <- igraph::strength(distance_sara_g)
centrality_distance_sara$Betweenness <- igraph::betweenness(distance_sara_g, weights = 1/E(distance_sara_g)$weight, normalized = T)
centrality_distance_sara$Eigen <- igraph::eigen_centrality(distance_sara_g)$vector

centrality_distance_anda$Strength <- igraph::strength(distance_anda_g)
centrality_distance_anda$Betweenness <- igraph::betweenness(distance_anda_g, weights = 1/E(distance_anda_g)$weight, normalized = T)
centrality_distance_anda$Eigen <- igraph::eigen_centrality(distance_anda_g)$vector
...
centrality_contact_mand$Type <- "Contact"
centrality_name_mand$Type <- "Name"
centrality_enviro_mand$Type <- "Enviro"
centrality_distance_mand$Type <- "House"

contact_df_mand <- rbind(centrality_contact_mand, centrality_name_mand,centrality_enviro_mand,centrality_distance_mand)
contact_df_mand$Village <- "M"

centrality_contact_anda$Type <- "Contact"
centrality_name_anda$Type <- "Name"
centrality_enviro_anda$Type <- "Enviro"
centrality_distance_anda$Type <- "House"

contact_df_anda <- rbind(centrality_contact_anda, centrality_name_anda,centrality_enviro_anda,centrality_distance_anda)
contact_df_anda$Village <- "A"

centrality_contact_sara$Type <- "Contact"
centrality_name_sara$Type <- "Name"
centrality_enviro_sara$Type <- "Enviro"
centrality_distance_sara$Type <- "House"

contact_df_sara <- rbind(centrality_contact_sara, centrality_name_sara,centrality_enviro_sara,centrality_distance_sara)
contact_df_sara$Village <- "S"

contact_df <- rbind(contact_df_mand, contact_df_anda, contact_df_sara)
...
corrplot(cor((centrality_name_mand[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_name_sara[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_name_anda[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)

corrplot(cor((centrality_enviro_mand[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_enviro_sara[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_enviro_anda[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)

corrplot(cor((centrality_contact_mand[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_contact_sara[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_contact_anda[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)

corrplot(cor((centrality_distance_mand[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_distance_sara[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)
corrplot(cor((centrality_distance_anda[,c(1,3:5)])),type = "lower", tl.col = "black",tl.srt = 0)

```

```{r Explore Centrality Correlations2}
cor_name_mand <- as.data.frame(cor((centrality_name_mand[,c(1,3:5)])))
cor_name_sara <-as.data.frame(cor((centrality_name_sara[,c(1,3:5)])))
cor_name_anda <-as.data.frame(cor((centrality_name_anda[,c(1,3:5)])))

cor_enviro_mand <-as.data.frame(cor((centrality_enviro_mand[,c(1,3:5)])))
cor_enviro_sara <-as.data.frame(cor((centrality_enviro_sara[,c(1,3:5)])))
cor_enviro_anda <-as.data.frame(cor((centrality_enviro_anda[,c(1,3:5)])))

cor_contact_mand <-as.data.frame(cor((centrality_contact_mand[,c(1,3:5)])))
cor_contact_sara <-as.data.frame(cor((centrality_contact_sara[,c(1,3:5)])))
cor_contact_anda <-as.data.frame(cor((centrality_contact_anda[,c(1,3:5)])))

cor_distance_mand <-as.data.frame(cor((centrality_distance_mand[,c(1,3:5)])))
cor_distance_sara <-as.data.frame(cor((centrality_distance_sara[,c(1,3:5)])))
cor_distance_anda <-as.data.frame(cor((centrality_distance_anda[,c(1,3:5)])))


cor_name_mand$Village <- "Mandena"
cor_name_sara$Village <- "Sarahandrano"
cor_name_anda$Village <- "Andatsakala"

cor_enviro_mand$Village <- "Mandena"
cor_enviro_sara$Village <- "Sarahandrano"
cor_enviro_anda$Village <- "Andatsakala"

cor_contact_mand$Village <- "Mandena"
cor_contact_sara$Village <- "Sarahandrano"
cor_contact_anda$Village <- "Andatsakala"

cor_distance_mand$Village <- "Mandena"
cor_distance_sara$Village <- "Sarahandrano"
cor_distance_anda$Village <- "Andatsakala"

cor_name_mand[2,1] <- NA
cor_name_mand[1,3] <- NA
cor_name_mand[1,4] <- NA
cor_name_mand[2,3] <- NA
cor_name_mand[2,4] <- NA
cor_name_mand[4,3] <- NA

cor_name_sara[2,1] <- NA
cor_name_sara[1,3] <- NA
cor_name_sara[1,4] <- NA
cor_name_sara[2,3] <- NA
cor_name_sara[2,4] <- NA
cor_name_sara[4,3] <- NA

cor_name_anda[2,1] <- NA
cor_name_anda[1,3] <- NA
cor_name_anda[1,4] <- NA
cor_name_anda[2,3] <- NA
cor_name_anda[2,4] <- NA
cor_name_anda[4,3] <- NA

cor_name <- rbind(cor_name_mand, cor_name_anda, cor_name_sara)
...
cor_name_mand_plot <- ggplot(data = cor_name2[cor_name2$Village=="Mandena",], aes(x = name, y=name2,  fill=value))+
...
cor_name_anda_plot <- ggplot(data = cor_name2[cor_name2$Village=="Andatsakala",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_name_sara_plot <- ggplot(data = cor_name2[cor_name2$Village=="Sarahandrano",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2,)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_name_plot <- ggarrange(cor_name_mand_plot, cor_name_sara_plot, cor_name_anda_plot, common.legend = TRUE, ncol = 3)




cor_enviro_mand[2,1] <- NA
cor_enviro_mand[1,3] <- NA
cor_enviro_mand[1,4] <- NA
cor_enviro_mand[2,3] <- NA
cor_enviro_mand[2,4] <- NA
cor_enviro_mand[4,3] <- NA

cor_enviro_sara[2,1] <- NA
cor_enviro_sara[1,3] <- NA
cor_enviro_sara[1,4] <- NA
cor_enviro_sara[2,3] <- NA
cor_enviro_sara[2,4] <- NA
cor_enviro_sara[4,3] <- NA

cor_enviro_anda[2,1] <- NA
cor_enviro_anda[1,3] <- NA
cor_enviro_anda[1,4] <- NA
cor_enviro_anda[2,3] <- NA
cor_enviro_anda[2,4] <- NA
cor_enviro_anda[4,3] <- NA

cor_enviro <- rbind(cor_enviro_mand, cor_enviro_anda, cor_enviro_sara)
...
cor_enviro_mand_plot <- ggplot(data = cor_enviro2[cor_enviro2$Village=="Mandena",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_enviro_anda_plot <- ggplot(data = cor_enviro2[cor_enviro2$Village=="Andatsakala",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_enviro_sara_plot <- ggplot(data = cor_enviro2[cor_enviro2$Village=="Sarahandrano",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2,)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_enviro_plot <-ggarrange(cor_enviro_mand_plot, cor_enviro_sara_plot, cor_enviro_anda_plot,ncol = 3)
...
cor_distance_mand[2,1] <- NA
cor_distance_mand[1,3] <- NA
cor_distance_mand[1,4] <- NA
cor_distance_mand[2,3] <- NA
cor_distance_mand[2,4] <- NA
cor_distance_mand[4,3] <- NA

cor_distance_sara[2,1] <- NA
cor_distance_sara[1,3] <- NA
cor_distance_sara[1,4] <- NA
cor_distance_sara[2,3] <- NA
cor_distance_sara[2,4] <- NA
cor_distance_sara[4,3] <- NA

cor_distance_anda[2,1] <- NA
cor_distance_anda[1,3] <- NA
cor_distance_anda[1,4] <- NA
cor_distance_anda[2,3] <- NA
cor_distance_anda[2,4] <- NA
cor_distance_anda[4,3] <- NA

cor_distance <- rbind(cor_distance_mand, cor_distance_anda, cor_distance_sara)
...
cor_distance_mand_plot <- ggplot(data = cor_distance2[cor_distance2$Village=="Mandena",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_distance_anda_plot <- ggplot(data = cor_distance2[cor_distance2$Village=="Andatsakala",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_distance_sara_plot <- ggplot(data = cor_distance2[cor_distance2$Village=="Sarahandrano",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2,)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_distance_plot <-ggarrange(cor_distance_mand_plot, cor_distance_sara_plot, cor_distance_anda_plot,ncol = 3)



cor_contact_mand[2,1] <- NA
cor_contact_mand[1,3] <- NA
cor_contact_mand[1,4] <- NA
cor_contact_mand[2,3] <- NA
cor_contact_mand[2,4] <- NA
cor_contact_mand[4,3] <- NA

cor_contact_sara[2,1] <- NA
cor_contact_sara[1,3] <- NA
cor_contact_sara[1,4] <- NA
cor_contact_sara[2,3] <- NA
cor_contact_sara[2,4] <- NA
cor_contact_sara[4,3] <- NA

cor_contact_anda[2,1] <- NA
cor_contact_anda[1,3] <- NA
cor_contact_anda[1,4] <- NA
cor_contact_anda[2,3] <- NA
cor_contact_anda[2,4] <- NA
cor_contact_anda[4,3] <- NA

cor_contact <- rbind(cor_contact_mand, cor_contact_anda, cor_contact_sara)
...
cor_contact_mand_plot <- ggplot(data = cor_contact2[cor_contact2$Village=="Mandena",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_contact_anda_plot <- ggplot(data = cor_contact2[cor_contact2$Village=="Andatsakala",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_contact_sara_plot <- ggplot(data = cor_contact2[cor_contact2$Village=="Sarahandrano",], aes(x = name, y=name2,  fill=value))+
  geom_tile(color="white", size=2,)+
  theme_classic()+
  xlab("Centrality")+
  ylab("Centrality")+
...
cor_contact_plot <-ggarrange(cor_contact_mand_plot, cor_contact_sara_plot, cor_contact_anda_plot,ncol = 3)
...
cor_name_plot <-ggarrange(cor_name_mand_plot, cor_name_sara_plot, cor_name_anda_plot,ncol = 3)
...
centrality_name_mand$Village <- "M"
centrality_name_anda$Village <- "A"
centrality_name_sara$Village <- "S"

centrality_name <- rbind(centrality_name_mand, centrality_name_anda, centrality_name_sara)
...
centrality_enviro_mand$Village <- "M"
centrality_enviro_anda$Village <- "A"
centrality_enviro_sara$Village <- "S"

centrality_enviro <- rbind(centrality_enviro_mand, centrality_enviro_anda, centrality_enviro_sara)
...
centrality_contact_mand$Village <- "M"
centrality_contact_anda$Village <- "A"
centrality_contact_sara$Village <- "S"

centrality_contact <- rbind(centrality_contact_mand, centrality_contact_anda, centrality_contact_sara)
...
centrality_distance_mand$Village <- "M"
centrality_distance_anda$Village <- "A"
centrality_distance_sara$Village <- "S"

centrality_distance <- rbind(centrality_distance_mand, centrality_distance_anda, centrality_distance_sara)
...
mean(centrality_name_mand$Strength)
mean(centrality_name_anda$Strength)
mean(centrality_name_sara$Strength)

mean(centrality_name_mand$PageRank)
mean(centrality_name_anda$PageRank)
mean(centrality_name_sara$PageRank)

mean(centrality_name_mand$Betweenness)
mean(centrality_name_anda$Betweenness)
mean(centrality_name_sara$Betweenness)

mean(centrality_name_mand$Eigen)
mean(centrality_name_anda$Eigen)
mean(centrality_name_sara$Eigen)

mean(centrality_enviro_mand$Strength)
mean(centrality_enviro_anda$Strength)
mean(centrality_enviro_sara$Strength)

mean(centrality_enviro_mand$PageRank)
mean(centrality_enviro_anda$PageRank)
mean(centrality_enviro_sara$PageRank)

mean(centrality_enviro_mand$Betweenness)
mean(centrality_enviro_anda$Betweenness)
mean(centrality_enviro_sara$Betweenness)

mean(centrality_enviro_mand$Eigen)
mean(centrality_enviro_anda$Eigen)
mean(centrality_enviro_sara$Eigen)

mean(centrality_contact_mand$Strength)
mean(centrality_contact_anda$Strength)
mean(centrality_contact_sara$Strength)

mean(centrality_contact_mand$PageRank)
mean(centrality_contact_anda$PageRank)
mean(centrality_contact_sara$PageRank)

mean(centrality_contact_mand$Betweenness)
mean(centrality_contact_anda$Betweenness)
mean(centrality_contact_sara$Betweenness)

mean(centrality_contact_mand$Eigen)
mean(centrality_contact_anda$Eigen)
mean(centrality_contact_sara$Eigen)

mean(centrality_distance_mand$Strength)
mean(centrality_distance_anda$Strength)
mean(centrality_distance_sara$Strength)

mean(centrality_distance_mand$PageRank)
mean(centrality_distance_anda$PageRank)
mean(centrality_distance_sara$PageRank)

mean(centrality_distance_mand$Betweenness)
mean(centrality_distance_anda$Betweenness)
mean(centrality_distance_sara$Betweenness)

mean(centrality_distance_mand$Eigen)
mean(centrality_distance_anda$Eigen)
mean(centrality_distance_sara$Eigen)
...
name_strength_pagerank <- ggplot(data = centrality_name_mand, aes(x = Strength, y= PageRank))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

name_strength_eigen<- ggplot(data = centrality_name_mand, aes(x = Strength, y= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

name_strength_betweenness<- ggplot(data = centrality_name_mand, aes(x = Strength, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

name_eigen_pagerank<- ggplot(data = centrality_name_mand, aes(x = PageRank, y= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

name_betweenness_pagerank<- ggplot(data = centrality_name_mand, aes(x = PageRank, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

name_eigen_betweenness <- ggplot(data = centrality_name_mand, aes(x = log(Betweenness), y= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()
...
enviro_strength_pagerank <- ggplot(data = centrality_enviro_mand, aes(x = Strength, y= PageRank))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

enviro_strength_eigen<- ggplot(data =centrality_enviro_mand, aes(x = Strength, y= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

enviro_strength_betweenness<- ggplot(data =centrality_enviro_mand, aes(x = Strength, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

enviro_eigen_pagerank<- ggplot(data = centrality_enviro_mand, aes(x = PageRank, y= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

enviro_betweenness_pagerank<- ggplot(data = centrality_enviro_mand, aes(x = PageRank, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

enviro_eigen_betweenness <- ggplot(data = centrality_enviro_mand, aes(x = log(Betweenness), y= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()
...
contact_strength_pagerank <- ggplot(data = centrality_contact_mand, aes(x = Strength, y= PageRank))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

contact_strength_eigen<- ggplot(data = centrality_contact_mand, aes(x = Strength, y= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

contact_strength_betweenness<- ggplot(data = centrality_contact_mand, aes(x = Strength, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

contact_eigen_pagerank<- ggplot(data = centrality_contact_mand, aes(x = PageRank, y= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

contact_betweenness_pagerank<- ggplot(data = centrality_contact_mand, aes(x = PageRank, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

contact_eigen_betweenness <- ggplot(data = centrality_contact_mand, aes(y = log(Betweenness), x= Eigen))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()
...
distance_strength_pagerank <- ggplot(data = centrality_distance_mand, aes(x = Strength, y= PageRank))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

distance_strength_eigen<- ggplot(data = centrality_distance_mand, aes(x = Strength, y= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

distance_strength_betweenness<- ggplot(data = centrality_distance_mand, aes(x = Strength, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

distance_eigen_pagerank<- ggplot(data = centrality_distance_mand, aes(x = PageRank, y= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

distance_betweenness_pagerank<- ggplot(data = centrality_distance_mand, aes(x = PageRank, y= log(Betweenness)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()

distance_eigen_betweenness <- ggplot(data = centrality_distance_mand, aes(y = log(Betweenness), x= log(Eigen)))+
  geom_point(alpha=0.1)+
  geom_smooth(method="lm")+
  theme_classic()
...
metadata$village[metadata$village=="Ampandrana"] <- "Andatsakala"
...
centrality_name_mand2 <- left_join(centrality_name_mand, metadata, by ="Node")
centrality_name_sara2 <- left_join(centrality_name_sara, metadata, by ="Node")
centrality_name_anda2 <- left_join(centrality_name_anda, metadata, by ="Node")

centrality_contact_mand2 <- left_join(centrality_contact_mand, metadata, by ="Node")
centrality_contact_sara2 <- left_join(centrality_contact_sara, metadata, by ="Node")
centrality_contact_anda2 <- left_join(centrality_contact_anda, metadata, by ="Node")

centrality_enviro_mand2 <- left_join(centrality_enviro_mand, metadata, by ="Node")
centrality_enviro_sara2 <- left_join(centrality_enviro_sara, metadata, by ="Node")
centrality_enviro_anda2 <- left_join(centrality_enviro_anda, metadata, by ="Node")

centrality_distance_mand2 <- left_join(centrality_distance_mand, metadata, by ="Node")
centrality_distance_sara2 <- left_join(centrality_distance_sara, metadata, by ="Node")
centrality_distance_anda2 <- left_join(centrality_distance_anda, metadata, by ="Node")


centrality_name_total2 <- rbind(centrality_name_mand2, centrality_name_sara2,centrality_name_anda2) %>% select(Node, PageRank, gender,  age, house_sol, commercial_goods, village, school_level, bmi, landsize_in_daba,  livestock, season, household_size, Strength, Betweenness, Eigen) %>% drop_na() #getting rid of all NA values removed 77 individuals (~6% of all nodes)

centrality_name_total2$season <- as.factor(centrality_name_total2$season)

centrality_name_mand_df <- centrality_name_total2[centrality_name_total2$village=="Mandena",]
centrality_name_sara_df <- centrality_name_total2[centrality_name_total2$village=="Sarahandrano",]
centrality_name_anda_df <- centrality_name_total2[centrality_name_total2$village=="Andatsakala",]

centrality_contact_total2 <- rbind(centrality_contact_mand2, centrality_contact_sara2,centrality_contact_anda2) %>% select(Node, PageRank, gender,  age, house_sol, commercial_goods, village, school_level, bmi, landsize_in_daba, livestock, season, household_size, Strength, Betweenness, Eigen) %>%drop_na()#getting rid of all NA values removed 36 individuals (~4% of all nodes)

centrality_contact_total2$season <- as.factor(centrality_contact_total2$season)


centrality_contact_mand_df <- centrality_contact_total2[centrality_contact_total2$village=="Mandena",]
centrality_contact_sara_df <- centrality_contact_total2[centrality_contact_total2$village=="Sarahandrano",]
centrality_contact_anda_df <- centrality_contact_total2[centrality_contact_total2$village=="Andatsakala",]

centrality_enviro_total2 <- rbind(centrality_enviro_mand2, centrality_enviro_sara2,centrality_enviro_anda2) %>% select(Node, PageRank, gender,  age, house_sol, commercial_goods, village, school_level, bmi, landsize_in_daba, livestock, season, household_size, Strength, Betweenness, Eigen) %>%drop_na()#getting rid of all NA values removed 42 individuals (~5% of all nodes)



centrality_enviro_mand_df <- centrality_enviro_total2[centrality_enviro_total2$village=="Mandena",]
centrality_enviro_sara_df <- centrality_enviro_total2[centrality_enviro_total2$village=="Sarahandrano",]
centrality_enviro_anda_df <- centrality_enviro_total2[centrality_enviro_total2$village=="Andatsakala",]


centrality_enviro_total2$season <- as.factor(centrality_enviro_total2$season)

centrality_distance_total2 <- rbind(centrality_distance_mand2, centrality_distance_sara2,centrality_distance_anda2) %>% select(Node, PageRank, gender,  age, house_sol, commercial_goods, village, school_level, bmi, landsize_in_daba, livestock, season, household_size, Strength, Betweenness, Eigen) %>%drop_na()#getting rid of all NA values removed 67 individuals (~5% of all nodes)

centrality_distance_total2$season <- as.factor(centrality_distance_total2$season)

centrality_distance_mand_df <- centrality_distance_total2[centrality_distance_total2$village=="Mandena",]
centrality_distance_sara_df <- centrality_distance_total2[centrality_distance_total2$village=="Sarahandrano",]
centrality_distance_anda_df <- centrality_distance_total2[centrality_distance_total2$village=="Andatsakala",]
...
model_avg_name_mand_1 <- perform_model_averaging(centrality_name_mand_df, 1)
model_avg_name_mand_1$Village <- "Mandena"
model_avg_name_mand_1$Network <- "Naming"

model_avg_name_sara_1 <- perform_model_averaging(centrality_name_sara_df, 1)
model_avg_name_sara_1$Village <- "Sarahandrano"
model_avg_name_sara_1$Network <- "Naming"

model_avg_name_anda_1 <- perform_model_averaging(centrality_name_anda_df, 1)
model_avg_name_anda_1$Village <- "Andatsakala"
model_avg_name_anda_1$Network <- "Naming"

model_avg_name_mand_2 <- perform_model_averaging(centrality_name_mand_df, 2)
model_avg_name_mand_2$Village <- "Mandena"
model_avg_name_mand_2$Network <- "Naming"


model_avg_name_sara_2 <- perform_model_averaging(centrality_name_sara_df, 2)
model_avg_name_sara_2$Village <- "Sarahandrano"
model_avg_name_sara_2$Network <- "Naming"

model_avg_name_anda_2 <- perform_model_averaging(centrality_name_anda_df, 2)
model_avg_name_anda_2$Village <- "Andatsakala"
model_avg_name_anda_2$Network <- "Naming"

model_avg_name_sara_3 <- perform_model_averaging(centrality_name_sara_df, 3)
model_avg_name_sara_3$Village <- "Sarahandrano"
model_avg_name_sara_3$Network <- "Naming"

model_avg_name_anda_3 <- perform_model_averaging(centrality_name_anda_df, 3)
model_avg_name_anda_3$Village <- "Andatsakala"
model_avg_name_anda_3$Network <- "Naming"

model_avg_contact_mand_1 <- perform_model_averaging(centrality_contact_mand_df, 1)
model_avg_contact_mand_1$Village <- "Mandena"
model_avg_contact_mand_1$Network <- "Close Contact"

model_avg_contact_sara_1 <- perform_model_averaging(centrality_contact_sara_df, 1)
model_avg_contact_sara_1$Village <- "Sarahandrano"
model_avg_contact_sara_1$Network <- "Close Contact"

model_avg_contact_anda_1 <- perform_model_averaging(centrality_contact_anda_df, 1)
model_avg_contact_anda_1$Village <- "Andatsakala"
model_avg_contact_anda_1$Network <- "Close Contact"

model_avg_contact_sara_2 <- perform_model_averaging(centrality_contact_sara_df, 2)
model_avg_contact_sara_2$Village <- "Sarahandrano"
model_avg_contact_sara_2$Network <- "Close Contact"

model_avg_contact_anda_2 <- perform_model_averaging(centrality_contact_anda_df, 2)
model_avg_contact_anda_2$Village <- "Andatsakala"
model_avg_contact_anda_2$Network <- "Close Contact"

model_avg_contact_sara_3 <- perform_model_averaging(centrality_contact_sara_df, 3)
model_avg_contact_sara_3$Village <- "Sarahandrano"
model_avg_contact_sara_3$Network <- "Close Contact"

model_avg_contact_anda_3 <- perform_model_averaging(centrality_contact_anda_df, 3)
model_avg_contact_anda_3$Village <- "Andatsakala"
model_avg_contact_anda_3$Network <- "Close Contact"

model_avg_enviro_mand_1 <- perform_model_averaging(centrality_enviro_mand_df, 1)
model_avg_enviro_mand_1$Village <- "Mandena"
model_avg_enviro_mand_1$Network <- "Environmental Overlap"

model_avg_enviro_sara_1 <- perform_model_averaging(centrality_enviro_sara_df, 1)
model_avg_enviro_sara_1$Village <- "Sarahandrano"
model_avg_enviro_sara_1$Network <- "Environmental Overlap"

model_avg_enviro_anda_1 <- perform_model_averaging(centrality_enviro_anda_df, 1)
model_avg_enviro_anda_1$Village <- "Andatsakala"
model_avg_enviro_anda_1$Network <- "Environmental Overlap"

model_avg_enviro_mand_2 <- perform_model_averaging(centrality_enviro_mand_df, 2)
model_avg_enviro_mand_2$Village <- "Mandena"
model_avg_enviro_mand_2$Network <- "Environmental Overlap"

model_avg_enviro_sara_2 <- perform_model_averaging(centrality_enviro_sara_df, 2)
model_avg_enviro_sara_2$Village <- "Sarahandrano"
model_avg_enviro_sara_2$Network <- "Environmental Overlap"

model_avg_enviro_anda_2 <- perform_model_averaging(centrality_enviro_anda_df, 2)
model_avg_enviro_anda_2$Village <- "Andatsakala"
model_avg_enviro_anda_2$Network <- "Environmental Overlap"

model_avg_enviro_sara_3 <- perform_model_averaging(centrality_enviro_sara_df, 3)
model_avg_enviro_sara_3$Village <- "Sarahandrano"
model_avg_enviro_sara_3$Network <- "Environmental Overlap"

model_avg_enviro_anda_3 <- perform_model_averaging(centrality_enviro_anda_df, 3)
model_avg_enviro_anda_3$Village <- "Andatsakala"
model_avg_enviro_anda_3$Network <- "Environmental Overlap"



model_avg_distance_mand_1 <- perform_model_averaging(centrality_distance_mand_df, 1)
model_avg_distance_mand_1$Village <- "Mandena"
model_avg_distance_mand_1$Network <- "Distance"

model_avg_distance_sara_1 <- perform_model_averaging(centrality_distance_sara_df, 1)
model_avg_distance_sara_1$Village <- "Sarahandrano"
model_avg_distance_sara_1$Network <- "Distance"

model_avg_distance_anda_1 <- perform_model_averaging(centrality_distance_anda_df, 1)
model_avg_distance_anda_1$Village <- "Andatsakala"
model_avg_distance_anda_1$Network <- "Distance"

model_avg_distance_mand_2 <- perform_model_averaging(centrality_distance_mand_df, 2)
model_avg_distance_mand_2$Village <- "Mandena"
model_avg_distance_mand_2$Network <- "Distance"

model_avg_distance_sara_2 <- perform_model_averaging(centrality_distance_sara_df, 2)
model_avg_distance_sara_2$Village <- "Sarahandrano"
model_avg_distance_sara_2$Network <- "Distance"

model_avg_distance_anda_2 <- perform_model_averaging(centrality_distance_anda_df, 2)
model_avg_distance_anda_2$Village <- "Andatsakala"
model_avg_distance_anda_2$Network <- "Distance"

model_avg_distance_sara_3 <- perform_model_averaging(centrality_distance_sara_df, 3)
model_avg_distance_sara_3$Village <- "Sarahandrano"
model_avg_distance_sara_3$Network <- "Distance"

model_avg_distance_anda_3 <- perform_model_averaging(centrality_distance_anda_df, 3)
model_avg_distance_anda_3$Village <- "Andatsakala"
model_avg_distance_anda_3$Network <- "Distance"
...
model_df <- rbind(model_avg_name_mand_1, model_avg_name_sara_1, model_avg_name_anda_1, model_avg_name_mand_2, model_avg_name_sara_2, model_avg_name_anda_2,
model_avg_name_sara_3, model_avg_name_anda_3) %>% filter(model == model2) %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable==variable)
...
model_df <- rbind(model_avg_enviro_mand_1, model_avg_enviro_sara_1, model_avg_enviro_anda_1, model_avg_enviro_mand_2, model_avg_enviro_sara_2, model_avg_enviro_anda_2,
model_avg_enviro_sara_3, model_avg_enviro_anda_3) %>% filter(model == model2) %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable==variable)
...
model_df <- rbind(model_avg_contact_mand_1, model_avg_contact_sara_1, model_avg_contact_anda_1,  model_avg_contact_sara_2, model_avg_contact_anda_2,
model_avg_contact_sara_3, model_avg_contact_anda_3) %>% filter(model == model2) %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable==variable)
...
model_df <- rbind(model_avg_distance_mand_1,   model_avg_distance_sara_2, model_avg_distance_anda_2,
model_avg_distance_sara_3, model_avg_distance_anda_3) %>% filter(model == model2) %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable==variable)
...
model_df1 <- rbind(model_avg_name_mand_1, model_avg_name_sara_1, model_avg_name_anda_1, model_avg_name_mand_2, model_avg_name_sara_2, model_avg_name_anda_2,
model_avg_name_sara_3, model_avg_name_anda_3) %>% filter(model == "betweenness") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df2 <- rbind(model_avg_name_mand_1, model_avg_name_sara_1, model_avg_name_anda_1, model_avg_name_mand_2, model_avg_name_sara_2, model_avg_name_anda_2,
model_avg_name_sara_3, model_avg_name_anda_3) %>% filter(model == "eigen") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df3 <- rbind(model_avg_name_mand_1, model_avg_name_sara_1, model_avg_name_anda_1, model_avg_name_mand_2, model_avg_name_sara_2, model_avg_name_anda_2,
model_avg_name_sara_3, model_avg_name_anda_3) %>% filter(model == "PageRank") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df4 <- rbind(model_avg_name_mand_1, model_avg_name_sara_1, model_avg_name_anda_1, model_avg_name_mand_2, model_avg_name_sara_2, model_avg_name_anda_2,
model_avg_name_sara_3, model_avg_name_anda_3) %>% filter(model == "Strength") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")



model_df1_enviro <- rbind(model_avg_enviro_mand_1, model_avg_enviro_sara_1, model_avg_enviro_anda_1, model_avg_enviro_mand_2, model_avg_enviro_sara_2, model_avg_enviro_anda_2,
model_avg_enviro_sara_3, model_avg_enviro_anda_3) %>% filter(model == "betweenness") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df2_enviro <- rbind(model_avg_enviro_mand_1, model_avg_enviro_sara_1, model_avg_enviro_anda_1, model_avg_enviro_mand_2, model_avg_enviro_sara_2, model_avg_enviro_anda_2,
model_avg_enviro_sara_3, model_avg_enviro_anda_3) %>% filter(model == "eigen") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df3_enviro <- rbind(model_avg_enviro_mand_1, model_avg_enviro_sara_1, model_avg_enviro_anda_1, model_avg_enviro_mand_2, model_avg_enviro_sara_2, model_avg_enviro_anda_2,
model_avg_enviro_sara_3, model_avg_enviro_anda_3) %>% filter(model == "PageRank") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")

model_df4 <- rbind(model_avg_enviro_mand_1, model_avg_enviro_sara_1, model_avg_enviro_anda_1, model_avg_enviro_mand_2, model_avg_enviro_sara_2, model_avg_enviro_anda_2,
model_avg_enviro_sara_3, model_avg_enviro_anda_3) %>% filter(model == "Strength") %>% select(Estimate, `Std. Error`, Variable, model, season, Village, Network) %>% filter(Variable== "genderMale")
```

```{r}

mand_eigen_name <- ggplot(data = centrality_name_mand, aes(x= log(Eigen)))+
  geom_histogram()+
  theme_classic()

sara_eigen_name <- ggplot(data = centrality_name_sara, aes(x= log(Eigen)))+
  geom_histogram()+
  theme_classic()

anda_eigen_name <- ggplot(data = centrality_name_anda, aes(x= log(Eigen)))+
  geom_histogram()+
  theme_classic()

ggarrange(mand_eigen_name, sara_eigen_name, anda_eigen_name, ncol=3, labels = c("Mandena", "Sarahandrano", "Andatsakala"))


mand_eigen_name_scatter <- ggplot(data = centrality_name_mand, aes(x= Eigen, y= PageRank))+
  geom_point()+
  theme_classic()

sara_eigen_name_scatter <- ggplot(data = centrality_name_sara, aes(x= Eigen, y= PageRank))+
  geom_point()+
  theme_classic()

anda_eigen_name_scatter <- ggplot(data = centrality_name_anda, aes(x= Eigen, y= PageRank))+
  geom_point()+
  theme_classic()

ggarrange(mand_eigen_name_scatter, sara_eigen_name_scatter, anda_eigen_name_scatter, ncol=3, labels = c("Mandena", "Sarahandrano", "Andatsakala"))


ggplot(data = centrality_distance_mand, aes(x= Eigen))+
  geom_histogram()+
  theme_classic()
...
unique(igraph::components(name_mand_g)$membership)
unique(igraph::components(name_anda_g)$membership)
unique(igraph::components(name_sara_g)$membership)
...
centrality_name_total3 <- centrality_name_total2 %>% pivot_longer(names_to = "centrality", values_to = "value", cols = c(Betweenness, Eigen, PageRank, Strength))
 ...
 name_model_average_coef$Importance[name_model_average_coef$Variable=="season2"] <-  importance$Importance[importance$Variable=="season"]
  ...
  name_model_average_coef$Importance[name_model_average_coef$Variable=="villageMandena"] <-  importance$Importance[importance$Variable=="village"]
   
 name_model_average_coef$Importance[name_model_average_coef$Variable=="villageSarahandrano"] <-  importance$Importance[importance$Variable=="village"]
...
centrality_distance_total3 <- centrality_distance_total2 %>% pivot_longer(names_to = "centrality", values_to = "value", cols = c(Betweenness, Eigen, PageRank, Strength))
 ...
 distance_model_average_coef$Importance[distance_model_average_coef$Variable=="season2"] <-  importance$Importance[importance$Variable=="season"]
  ...
  distance_model_average_coef$Importance[distance_model_average_coef$Variable=="villageMandena"] <-  importance$Importance[importance$Variable=="village"]
   
 distance_model_average_coef$Importance[distance_model_average_coef$Variable=="villageSarahandrano"] <-  importance$Importance[importance$Variable=="village"]
...
centrality_contact_total3 <- centrality_contact_total2 %>% pivot_longer(names_to = "centrality", values_to = "value", cols = c(Betweenness, Eigen, PageRank, Strength))
 ...
 contact_model_average_coef$Importance[contact_model_average_coef$Variable=="season2"] <-  importance$Importance[importance$Variable=="season"]
  ...
  contact_model_average_coef$Importance[contact_model_average_coef$Variable=="season3"] <-  importance$Importance[importance$Variable=="season"]
   ...
   contact_model_average_coef$Importance[contact_model_average_coef$Variable=="villageMandena"] <-  importance$Importance[importance$Variable=="village"]
   
     contact_model_average_coef$Importance[contact_model_average_coef$Variable=="villageSarahandrano"] <-  importance$Importance[importance$Variable=="village"]
...
centrality_enviro_total3 <- centrality_enviro_total2 %>% pivot_longer(names_to = "centrality", values_to = "value", cols = c(Betweenness, Eigen, PageRank, Strength))
 ...
 enviro_model_average_coef$Importance[enviro_model_average_coef$Variable=="season2"] <-  importance$Importance[importance$Variable=="season"]
  ...
  enviro_model_average_coef$Importance[enviro_model_average_coef$Variable=="season3"] <-  importance$Importance[importance$Variable=="season"]
   ...
   enviro_model_average_coef$Importance[enviro_model_average_coef$Variable=="villageMandena"] <-  importance$Importance[importance$Variable=="village"]
   
     enviro_model_average_coef$Importance[enviro_model_average_coef$Variable=="villageSarahandrano"] <-  importance$Importance[importance$Variable=="village"]
